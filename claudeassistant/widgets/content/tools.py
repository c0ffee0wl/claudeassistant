...
from claudeassistant.widgets.primitives.button import Button
from claudeassistant.widgets.primitives.collapsible import QuietCollapsible

from claude_agent_sdk import ToolUseBlock, ToolResultBlock

from claudeassistant.enums import ToolName
from claudeassistant.formatting import (
    format_tool_header,
    format_tool_input,
...
from claudeassistant.widgets.content.message import ChatMessage
from claudeassistant.widgets.primitives.spinner import Spinner
...
class TaskWidget(BaseToolWidget):
    ...
    RECENT_EXPANDED = 0  # Keep last N tool uses expanded within task
