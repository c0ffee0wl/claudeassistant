...
from claudeassistant.formatting import MAX_CONTEXT_TOKENS
from claudeassistant.profiling import profile, timed
...
class CPUBar(IndicatorWidget):
    ...
    def on_click(self, event) -> None:
        ...
        from claudeassistant.widgets.modals.profile import ProfileModal
