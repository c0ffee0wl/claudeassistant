...
from claudeassistant.permissions import PermissionRequest
from claudeassistant.tasks import create_safe_task

if TYPE_CHECKING:
    from claudeassistant.protocols import AgentObserver, PermissionHandler
...
class Agent:
    ...
    async def connect(
        ...
        from claudeassistant.processes import get_claude_pid_from_client
    ...
    async def load_history(self, cwd: Path | None = None) -> None:
        ...
        """
        from claudeassistant.sessions import load_session_messages
    ...
    def _handle_tool_result(self, block: ToolResultBlock) -> None:
        """Handle tool result."""
        from claudeassistant.processes import parse_background_task_output
    ...
    def get_background_processes(self) -> list:
        ...
        if not self._claude_pid:
            return []
        from claudeassistant.processes import get_child_processes
