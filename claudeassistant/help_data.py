...
# Claude Assistant-specific commands (imported from single source of truth)
def _get_chic_commands() -> list[tuple[str, str]]:
    from claudeassistant.commands import get_help_commands
...
# MCP tools from claudeassistant (mcp.py)
MCP_TOOLS = [
...
async def format_help(agent: "Agent | None") -> str:
    ...
    lines.append("## Claude Assistant Commands\n")
    lines.append("| Command | Description |")
    lines.append("|---------|-------------|")
