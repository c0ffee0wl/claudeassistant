"""HTTP server for remote control of claudeassistant.
...
Start with --remote-port flag or CLAUDE_ASSISTANT_REMOTE_PORT env var.
"""
...
async def handle_send(request: web.Request) -> web.Response:
    ...
    if stripped.startswith("/") or stripped.startswith("!"):
        from claudeassistant.commands import handle_command as do_command
