...
def handle_command(app: "ChatApp", prompt: str) -> bool:
    ...
    if cmd_name in CLAUDE_CLI_COMMANDS:
        app.notify(
            f"'{cmd_name}' is not available in claudeassistant.\nUse 'claude' CLI instead.",
            severity="warning",
            timeout=5,
        )
        return True
...
def _handle_resume(app: "ChatApp", command: str) -> bool:
    ...
    from claudeassistant.sessions import find_session_by_prefix
...
def _handle_agent(app: "ChatApp", command: str) -> bool:
    ...
    from claudeassistant.widgets import ChatMessage
    ...
    if len(parts) == 1:
        ...
        has_content = len(app.agents) > 1 or app.todo_panel.todos
...
def _handle_welcome(app: "ChatApp") -> bool:
    ...
    welcome_prompt = """\
Welcome the user to Claude Assistant. Present this message exactly:
...
Links: [Docs](https://matthewrocklin.com/claudeassistant) · [GitHub](https://github.com/mrocklin/claudeassistant) · [Video](https://www.youtube.com/watch?v=2HcORToX5sU)
...
def _handle_compactish(app: "ChatApp", command: str) -> bool:
    ...
    """
    from claudeassistant.compact import compact_session, format_compact_summary
    from claudeassistant.widgets import ChatMessage
...
async def _handle_help(app: "ChatApp") -> None:
    ...
    from claudeassistant.help_data import format_help
    from claudeassistant.widgets import ChatMessage
...
def _handle_processes(app: "ChatApp") -> None:
    ...
    from claudeassistant.widgets.modals.process_modal import ProcessModal
