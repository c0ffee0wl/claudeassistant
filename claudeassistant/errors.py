...
def setup_logging(level: int = logging.DEBUG) -> None:
    ...
    Configures the root 'claudeassistant' logger so all child loggers
    (claudeassistant.app, claudeassistant.widgets.*, etc.) inherit the handlers.

    Reads configuration from ~/.claude/.claudeassistant.yaml:
    - logging.file: Path to log file, or null to disable (default: ~/claudeassistant.log)
