...
from claudeassistant.widgets.layout.sidebar import SessionItem
...
class SessionScreen(Screen[str | None]):
    ...
    def on_mount(self) -> None:
        from claudeassistant.sessions import count_sessions
    ...
    async def _fetch_sessions(self, search: str) -> list[tuple[str, str, float, int]]:
        from claudeassistant.sessions import get_recent_sessions
