...
Claude Assistant combines two libraries:
...
The only reason Claude Assistant looks good is because Textual makes it really easy to make the terminal look good.
...
It's trivial to add features to Claude Assistant, or to build your own version.   Please enjoy playing with code.
